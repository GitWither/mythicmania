...
=======
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, WastedDemonEntity::new).dimensions(EntityDimensions.fixed(1.25f, 2f)).build()
>>>>>>> a91c442b3145dc0adc46dcdae6a9d9d916b15892
    );
