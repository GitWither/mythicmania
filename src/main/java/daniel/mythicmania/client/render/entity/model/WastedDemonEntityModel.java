...
public class WastedDemonEntityModel<T extends Entity> extends PlayerEntityModel<WastedDemonEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData horn1 = horns.addChild("horn1", ModelPartBuilder.create(), ModelTransform.pivot(2.5F, -35.0F, 0.0F));
        ModelPartData cube_r1 = horn1.addChild("cube_r1", ModelPartBuilder.create().uv(116, 0).cuboid(-1.75F, -6.5F, -1.0F, 3.0F, 7.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, -2.0F, -0.1745F, 0.0F, 0.0F));
        ModelPartData horn2 = horns.addChild("horn2", ModelPartBuilder.create(), ModelTransform.pivot(-2.0F, -35.25F, 0.0F));
        ModelPartData cube_r2 = horn2.addChild("cube_r2", ModelPartBuilder.create().uv(116, 0).mirrored().cuboid(-1.25F, -6.5F, -1.0F, 3.0F, 7.0F, 2.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(-0.5F, 0.25F, -2.0F, -0.1745F, 0.0F, 0.0F));
