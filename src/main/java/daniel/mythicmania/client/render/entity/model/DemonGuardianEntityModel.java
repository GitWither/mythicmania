...
public class DemonGuardianEntityModel extends PlayerEntityModel<DemonGuardianEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData right_arm = modelPartData.addChild("right_arm", ModelPartBuilder.create(), ModelTransform.pivot(-4.0F, 6.0F, -1.0F));

        ModelPartData cube_r2 = right_arm.addChild("cube_r2", ModelPartBuilder.create().uv(48, 0).mirrored().cuboid(0.0F, -7.0F, 1.0F, 4.0F, 10.0F, 4.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(-4.0F, 4.25F, -3.5F, 0.0F, 0.0F, 0.1309F));
        ...
        ModelPartData right_sleeve = modelPartData.addChild("right_sleeve", ModelPartBuilder.create(), ModelTransform.pivot(-4.0F, 6.0F, -1.0F));

        ModelPartData arm_r_inflated_r1 = right_sleeve.addChild("arm_r_inflated_r1", ModelPartBuilder.create().uv(16, 46).mirrored().cuboid(0.0F, -7.0F, 1.0F, 4.0F, 10.0F, 4.0F, new Dilation(0.2F)).mirrored(false), ModelTransform.of(-4.0F, 4.25F, -3.5F, 0.0F, 0.0F, 0.1309F));
        ...
        ModelPartData left_arm = modelPartData.addChild("left_arm", ModelPartBuilder.create(), ModelTransform.pivot(4.0F, 6.0F, -1.0F));

        ModelPartData cube_r3 = left_arm.addChild("cube_r3", ModelPartBuilder.create().uv(48, 0).cuboid(-4.0F, -7.0F, 1.0F, 4.0F, 10.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(4.0F, 4.25F, -3.5F, 0.0F, 0.0F, -0.1309F));

        ModelPartData left_sleeve = modelPartData.addChild("left_sleeve", ModelPartBuilder.create(), ModelTransform.pivot(4.0F, 6.0F, -1.0F));

        ModelPartData arm_l_inflated_r1 = left_sleeve.addChild("arm_l_inflated_r1", ModelPartBuilder.create().uv(16, 46).cuboid(-4.0F, -7.0F, 1.0F, 4.0F, 10.0F, 4.0F, new Dilation(0.2F)), ModelTransform.of(4.0F, 4.25F, -3.5F, 0.0F, 0.0F, -0.1309F));
