...
public class MythicMania implements ModInitializer {
    ...
    public static final ItemGroup MYTHICMANIA_COMBAT_ITEM_GROUP = FabricItemGroupBuilder.build(new Identifier(MOD_ID, "combat"), () -> new ItemStack(MythicManiaItems.RUINOUS_SWORD));
